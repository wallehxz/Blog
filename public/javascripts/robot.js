...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
            showMessage("秘密通道:<br /><a href=\"http://www.611zy.la\" title=\"学习进阶\">进阶</a><a href=\"http://dadouya.coding.io\" title=\"大豆芽小站\">首页</a>",10000);
        }
    });
...
jQuery(document).ready(function ($) {
    $('a').click(function () {//标题被点击时
        showMessage('正在用吃奶的劲加载<span style="color:#0099cc;">' + $(this).text() + '</span>雀多吗嘚！');
    });
    $('a').mouseover(function () {
        showMessage('点击可以得到更多关于<span style="color:#ff0000;">' + $(this).text() + '</span>的内容哦！');
    });
...
jQuery(document).ready(function ($) {
    var stat_click = 0;
    $(".mumu").click(function () {
        if($(document).scrollTop() > $(window).height() / 2) { //当页面的滚动草果半屏时，可以回滚到顶部
